        ...
        <div className="container px-5 py-24 mx-auto">
            <div className="flex flex-col">
                ...
                <div className="flex flex-wrap sm:flex-row flex-col py-6 mb-12">
                    <h1 className="sm:w-2/5 text-yellow-900 dark:text-yellow-50 font-medium title-font text-2xl mb-2 sm:mb-0">Space The Final Frontier</h1>
            ...
            <div className="flex flex-wrap sm:-m-4 -mx-4 -mb-10 -mt-4">
                <div className="p-4 md:w-1/3 sm:mb-0 mb-6">
                    ...
                    <h2 className="text-xl font-medium title-font text-gray-700 dark:text-gray-200 mt-5">Shooting Stars</h2>
                    
                    <a className="text-yellow-400 inline-flex items-center mt-3">View
                ...
                <div className="p-4 md:w-1/3 sm:mb-0 mb-6">
                    ...
                    <h2 className="text-xl font-medium title-font text-gray-700 dark:text-gray-200 mt-5">The Catalyzer</h2>
                    
                    <a className="text-yellow-200 inline-flex items-center mt-3">Learn More
                    <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" className="w-4 h-4 ml-2" viewBox="0 0 24 24">
                        <path d="M5 12h14M12 5l7 7-7 7"></path>
                    </svg>
                    </a>
                ...
                <div className="p-4 md:w-1/3 sm:mb-0 mb-6">
                    ...
                    <h2 className="text-xl font-medium title-font text-gray-700 dark:text-gray-200 mt-5">The 400 Blows</h2>
