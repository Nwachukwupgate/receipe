        ...
        <div className="container m-auto px-6 pt-8 md:px-12 lg:pt-[1.8rem] lg:px-7">
            <div className="flex items-center flex-wrap px-2 md:px-0">
                <div className="relative lg:w-6/12 lg:py-14 xl:py-16">
                    <h1 className="font-bold text-3xl text-yellow-900 dark:text-yellow-50 md:text-5xl lg:w-10/12">Welcome to Recipes </h1>
                    <h3 className="font-semibold text-2xl text-yellow-900 pt-2 dark:text-yellow-50 md:text-3xl lg:w-10/12">Discover, Create, and Savor the Best Recipes from Around the World</h3>
                ...
                <div className="-mb-10 lg:w-6/12">
                    <img 
                        ...
                        className="relative w-full h-auto  md:w-3/4 sm:w-1/2"
